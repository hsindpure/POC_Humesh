...
var config = {
	host: 'dqimak984b0i6a5.in.qlikcloud.com',
	prefix: '/',
    port: 443,
  isSecure: true,
  webIntegrationId: "RuL0PUQZWK3boArNHESg29a0WbJxtxxz"
};
...
window.qlik = qlik;
	...
	function getQlikApp () {
		...
		return qlik.openApp( "3bc440b7-d4fe-4def-92fe-fdf5f5ffa7a3", config );
	...
	app.getObject('QV-05','CLfuxL');
	app.getObject('QV-04','akDGX');
	app.getObject('QV-03','vCNaSe');
